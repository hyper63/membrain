...
<form id="login-form" on:submit|preventDefault={handleLogin}>
  ...
  <input id="login-username" type="text" required placeholder="Username" bind:value={username}>
  <input id="login-password" type="password" required placeholder="Password" bind:value={password}>
